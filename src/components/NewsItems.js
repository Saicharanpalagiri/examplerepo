...
export default function NewsItems() {
  return (
    ...
    <div>
      ...
      >
        <a  style={{margin:'100px'}} href="https://www.livemint.com/brand-stories/licious-is-india-s-first-animal-protein-brand-to-be-certified-with-sa8000-11655299956590.html">
          <div
            style={{
              textAlign: "center",
              // background: 'red',
        ...
        <a  style={{margin:'100px'}} href="https://yourstory.com/2021/11/licious-continuous-liquidity-esops-daily-vesting/amp">
          <div
            style={{
              textAlign: "center",
              // background: 'orange',
        ...
        <a  style={{margin:'100px'}} href="https://the-ken.com/story/why-licious-wants-to-become-the-everything-store-for-meat/">
          <div
            style={{
              textAlign: "center",
              // background: 'yellow',
