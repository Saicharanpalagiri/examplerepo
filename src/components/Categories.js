...
let a=''
const categorySearch=(itemNew)=>{
        setTimeout(()=>{ if(itemNew){
            a=searchResults.filter((item)=>{
               return(
                       item.title.toLowerCase().includes(itemNew.substr(0,2))
               )
               })
               console.log(a)
               navigate('/search',{
 ...
 className='headerCategory' >
  ...
  <MenuList>
    ...
    <MenuItem minH='40px'>
        {/* <Link className="link_flex" to={'/chicken'}> 
         */}
         <Button  backgroundColor={'white'} onClick={()=>categorySearch('chicken')}>
    ...
    <MenuItem minH='48px'>
        {/* <Link className="link_flex" to={'/fish'} > */}
        <Button  backgroundColor={'white'} onClick={()=>categorySearch('fish')}>
    ...
    <MenuItem minH='48px'>
        {/* <Link className="link_flex " to={'/fish'} > */}
        <Button  backgroundColor={'white'} onClick={()=>categorySearch('mutton')}>
    ...
    <MenuItem minH='48px'>
        {/* <Link className="link_flex" to={'/fish'} > */}
        <Button  backgroundColor={'white'} onClick={()=>categorySearch('prawns')}>
        <Image
        boxSize='2.3rem'
        borderRadius='5px'
    ...
    <MenuItem minH='48px'>
        {/* <Link className="link_flex" to={'/fish'} > */}
        <Button  backgroundColor={'white'} onClick={()=>categorySearch('eggs')}>
    ...
    <MenuItem minH='48px'>
        {/* <Link className="link_flex" to={'/fish'} > */}
        <Button  backgroundColor={'white'} onClick={()=>categorySearch('biryani')}>
        <Image
       boxSize='2.3rem'
       borderRadius='5px'
